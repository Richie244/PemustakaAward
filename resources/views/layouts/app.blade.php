        ...
        <aside class="w-64 bg-white p-5 shadow-md h-screen fixed top-0 left-0">
            ...
            <nav class="mt-5">
                <ul>
                    <li class="mb-3">
                        <div
                            class="flex items-center p-3 rounded-lg {{ Request::is('/') ? 'bg-[rgba(31,76,109,1)] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                    ...
                    <li class="mb-3">
                        <div
                            class="flex items-center p-3 rounded-lg {{ Request::is('profile') ? 'bg-[rgba(31,76,109,1)] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                    ...
                    <li class="mb-3">
                        <div
                            class="flex items-center p-3 rounded-lg {{ Request::is('kegiatan') || Request::is('riwayatkegiatan') ? 'bg-[rgba(31,76,109,1)] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                            <img src="{{ Request::is('kegiatan') || Request::is('riwayatkegiatan') ? asset('assets/images/Kegiatan.png') : asset('assets/images/BlackKegiatan.png') }}"
                    ...
                    <li>
                        <div
                            class="flex items-center p-3 rounded-lg {{ Request::is('aksara') || Request::is('formaksaradinamika') ? 'bg-[rgba(31,76,109,1)] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                            <img src="{{ Request::is('aksara') || Request::is('formaksaradinamika') ? asset('assets/images/Aksara.png') : asset('assets/images/BlackAksara.png') }}"
